...
def tod():
    titik = ['\x1b[1;91m.   ', '\x1b[1;92m..  ', '\x1b[1;93m... ','\x1b[1;91m.   ', '\x1b[1;92m..  ', '\x1b[1;93m... ']
    for x in titik:
...
def mr_error():
    ...
    if innocent == '':
        ...
        try:
            ...
            for fuck in total:
            	nunu = fuck.replace("\n","")
                titid  = nunu.replace(" [✓] "," \x1b[0m[\x1b[1;92m✓\x1b[0m]\x1b[1;92m ").replace(" [×] ", " \x1b[0m[\x1b[1;91m×\x1b[0m]\x1b[1;91m ")
...
def teman(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/me/friends?access_token=%s'%(nunu)).json()["data"]:
            ...
            w = random.choice(['\x1b[1;95m', '\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;92m', '\x1b[1;91m', '\x1b[0m'])
...
def followers(nunu):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/subscribers?access_token=%s'%(mravu,nunu)).json()["data"]:
            id.append(a['id'] + '<=>' + a['name'])
            ys.write(a['id'] + '<=>' + a['name'] + '\n')
            w = random.choice(['\x1b[1;95m', '\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;98m', '\x1b[1;96m', '\x1b[1;91m', '\x1b[0m'])
